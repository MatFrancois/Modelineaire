...
Dans un premier temps nous avons utilisé le modèle mis à disposition dans l’énoncé qui permettait de prédire chaque gêne en fonction de l'age et le sexe du candidat, le tissue cancérigène, son statut, et le projet d'étude associé. Afin d'améliorer ces 21 modèles similaires, nous avons décidé d'ajouter un "step()" dans le code. Cela permettant d’affiner chaque régression linéaire, en supprimant les variables qui n'ont pas d'impact sur la valeur du gêne choisit. 
